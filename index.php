...
$host = 'mysql57'; // Cambia esto si tu base de datos no está en tu mismo servidor
...
$base_datos = 'mysql57'; // Cambia esto por el nombre de tu base de datos
...
if ($resultado->num_rows > 0) {
    // Crear la tabla HTML
    echo "<table border='1'>";
    echo "<h1> MySql 5.7  connection test";
